...
import (
	...
	"github.com/phanletrunghieu/example-go/endpoints/book"
	"github.com/phanletrunghieu/example-go/endpoints/category"
	"github.com/phanletrunghieu/example-go/endpoints/lend_book"
	"github.com/phanletrunghieu/example-go/endpoints/user"
)
